...
public class StudentServiceSpringImpl implements StudentServiceInt {
	...
	/* (non-Javadoc)
	 * @see in.co.rays.project_0.service.StudentServiceInt#add(in.co.rays.project_0.dto.StudentDTO)
	 */
	...
	/* (non-Javadoc)
	 * @see in.co.rays.project_0.service.StudentServiceInt#update(in.co.rays.project_0.dto.StudentDTO)
	 */
	@Transactional(propagation=Propagation.REQUIRED,readOnly=false)
	...
	/* (non-Javadoc)
	 * @see in.co.rays.project_0.service.StudentServiceInt#delete(long)
	 */
	@Transactional(propagation=Propagation.REQUIRED,readOnly=false)
	...
	/* (non-Javadoc)
	 * @see in.co.rays.project_0.service.StudentServiceInt#findByPK(long)
	 */
	...
	/* (non-Javadoc)
	 * @see in.co.rays.project_0.service.StudentServiceInt#findByEmail(java.lang.String)
	 */
	@Transactional(readOnly=true)
