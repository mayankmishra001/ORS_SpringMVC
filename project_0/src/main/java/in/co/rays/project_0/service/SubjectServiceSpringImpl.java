...
public class SubjectServiceSpringImpl implements SubjectServiceInt {
	...
	/* (non-Javadoc)
	 * @see in.co.rays.project_0.service.SubjectServiceInt#add(in.co.rays.project_0.dto.SubjectDTO)
	 */
	...
	/* (non-Javadoc)
	 * @see in.co.rays.project_0.service.SubjectServiceInt#update(in.co.rays.project_0.dto.SubjectDTO)
	 */
	@Transactional(propagation = Propagation.REQUIRED, readOnly = false)
	...
	/* (non-Javadoc)
	 * @see in.co.rays.project_0.service.SubjectServiceInt#delete(long)
	 */
	@Transactional(propagation = Propagation.REQUIRED, readOnly = false)
	...
	/* (non-Javadoc)
	 * @see in.co.rays.project_0.service.SubjectServiceInt#findByName(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see in.co.rays.project_0.service.SubjectServiceInt#findById(java.lang.Long)
	 */
	@Transactional(readOnly = true)
	...
	/* (non-Javadoc)
	 * @see in.co.rays.project_0.service.SubjectServiceInt#search(in.co.rays.project_0.dto.SubjectDTO, int, int)
	 */
	@Transactional(readOnly = true)
	...
	/* (non-Javadoc)
	 * @see in.co.rays.project_0.service.SubjectServiceInt#search(in.co.rays.project_0.dto.SubjectDTO)
	 */
	@Transactional(readOnly = true)
